...
window.UsageView = (() => {
  ...
  async function show() {
    ...
    try {
      ...
      target.innerHTML = `<dl class="usage-values"><div><dt>本期已用</dt><dd>${Number(data.used)} 次</dd></div><div><dt>个人剩余</dt><dd>${Number(data.remaining)} 次</dd></div><div><dt>每日上限</dt><dd>${Number(data.limit)} 次</dd></div></dl>
